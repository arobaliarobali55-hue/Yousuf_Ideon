...
export const SparklesIcon: React.FC<IconProps> = ({ className }) => (
  <svg xmlns="http://www.w3.org/2000/svg" className={className} width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
    ...
    <path d="M22 2L20 4" /><path d="M4 2L2 4" /><path d="M2 20l2 2" /><path d="M20 22l2-2" />
  </svg>
);
...
export const FacebookIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} width="24" height="24" viewBox="0 0 24 24" fill="currentColor" stroke="none">
...
export const TwitterIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} width="24" height="24" viewBox="0 0 24 24" fill="currentColor" stroke="none">
        <path d="M22 4s-.7 2.1-2 3.4c1.6 1.4 3.3 4.9 3.3 4.9-1.4 1-3.3 1.2-3.3 1.2.1 4.3-1.3 6.1-4.7 6.1-2.1 0-4.1-.9-4.1-.9s-1.8 1.4-4.2-1.2c-1.3-1.3-2.1-3.1-2.1-3.1s-.8 1.4-2.8-1.3c0 0-.2-2.8 2.5-4.4 1.3-1.3 4.1-1.2 4.1-1.2s-.5-1.2-1.2-1.8c-.8-1-1.5-1.5-1.5-1.5s2.8-.2 4.9 2.4c.8.9 1.4 2.1 1.4 2.1s3.3-.9 4.9-2.4c-.4.4-1.3 2.1-1.3 2.1s1.8-1.4 3.3-2.2z"></path>
    </svg>
);
...
export const WhatsAppIcon: React.FC<IconProps> = ({ className }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} width="24" height="24" viewBox="0 0 24 24" fill="currentColor" stroke="none">
        <path d="M21.926 10.116c-.284-5.558-4.85-10.038-10.422-10.116-5.835-.08-10.625 4.516-10.584 10.34.038 5.39 4.34 9.813 9.73 10.096l.407.018h.002c.48.013.96.005 1.438-.023l.119-.006c4.863-.44 8.76-4.49 8.98-9.355zm-6.234 5.582c-.15.423-.9.768-1.232.81-.29.037-.633.036-1.002-.135-.852-.395-1.638-.9-2.3-1.524-.91-.81-1.644-1.8-2.115-2.922-.224-.523-.43-1.11-.41-1.71.026-.643.308-1.22.84-1.64.24-.188.51-.29.78-.302.22-.01.44-.004.65.05.282.072.443.19.58.48.16.324.27.67.43.99.13.25.18.52.05.78l-.51 1.1c-.08.18-.03.39.1.54 1.023 1.15 2.13 2.14 3.41 2.92.14.09.3.1.44.03l1.15-.56c.26-.13.55-.09.78.07.31.22.6.47.85.75.25.28.38.61.32.96z"></path>
    </svg>
);
